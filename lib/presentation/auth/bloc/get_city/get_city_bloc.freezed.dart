...
mixin _$GetCityState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<City> result) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<City> result)? loaded,
...
class _$loadedImpl implements _loaded {
  const _$loadedImpl(final List<City> result) : _result = result;
  ...
  @override
  String toString() {
    return 'GetCityState.loaded(result: $result)';
  }
...
abstract class _loaded implements GetCityState {
  const factory _loaded(final List<City> result) = _$loadedImpl;
