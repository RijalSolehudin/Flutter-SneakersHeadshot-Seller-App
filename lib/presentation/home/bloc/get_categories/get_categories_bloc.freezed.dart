...
mixin _$GetCategoriesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Categories> data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Categories> data)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Categories> data) : _data = data;
  ...
  @override
  String toString() {
    return 'GetCategoriesState.loaded(data: $data)';
  }
...
abstract class _Loaded implements GetCategoriesState {
  const factory _Loaded(final List<Categories> data) = _$LoadedImpl;
